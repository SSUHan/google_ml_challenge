...
class CnnLogisticModel(models.BaseModel):
  ...
  def create_model(self, model_input, num_classes=2, l2_penalty=1e-8, **unused_params):
    ...
    net = slim.conv2d(model_input, 64, [3, 3], scope='conv1_2')
    net = slim.max_pool2d(net, [2, 2], scope='pool1')

    net = slim.conv2d(model_input, 128, [3, 3], scope='conv2_1')
    net = slim.conv2d(model_input, 128, [3, 3], scope='conv2_2')
    net = slim.max_pool2d(net, [2, 2], scope='pool2')

    net = slim.conv2d(model_input, 258, [3, 3], scope='conv3_1')
    net = slim.conv2d(model_input, 258, [3, 3], scope='conv3_2')
